...
import com.jonm.model.dto.Comment;
...
import com.jonm.service.CommentService;
import com.jonm.service.FriendService;
import com.jonm.service.impl.UserServiceImpl;
import com.jonm.util.EncryptUtils;
import com.jonm.util.IpAddressUtils;
import com.jonm.util.JwtUtils;
import com.jonm.util.MailUtils;
import com.jonm.util.QQInfoUtils;
	...
	private void judgeSendMail(Comment comment, boolean isVisitorComment, String path) {
		...
		if (isVisitorComment) {
			...
			if (comment.getParentCommentId() != -1) {
				com.jonm.entity.Comment parentComment = commentService.getCommentById(comment.getParentCommentId());
				//访客回复我的评论，邮件提醒我自己
