...
CREATE TABLE `blog`  (
  ...
  `words` int(0) NULL DEFAULT NULL COMMENT '文章字数',
  `read_time` int(0) NULL DEFAULT NULL COMMENT '阅读时长(分钟)',
...
INSERT INTO `site_setting` VALUES (21, 'email', 'email', 'mailto:i@naccl.com', 3);
